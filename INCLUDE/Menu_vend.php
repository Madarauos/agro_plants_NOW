        ...
        <aside class="jp_sidebar">
            ...
            <nav>
                <ul>
                    ...
                    <button onclick= "window.location.href='../../VIEW/vend/lista-vendas.php'"><li id="vendas"><img src="https://raw.githubusercontent.com/feathericons/feather/master/icons/shopping-cart.svg" alt=""> Vendas</li></button> 

                    <button onclick= "window.location.href='../../VIEW/vend/Cupom_vendedor.php'"><li id="cupons"><img src="https://raw.githubusercontent.com/feathericons/feather/master/icons/tag.svg" alt=""> Cupons</li></button> 
                </ul>
            </nav>
